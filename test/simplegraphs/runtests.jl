...
import GraphsBase.SimpleGraphs: fadj, badj, adj
import GraphsBase.edgetype, Graphs.has_edge
using Statistics: mean

struct DummySimpleEdge <: AbstractSimpleEdge{T} end
struct DummySimpleGraph <: AbstractGraph{T, DummySimpleEdge} end
